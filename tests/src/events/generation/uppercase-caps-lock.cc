...
std::vector<KeyParam> generateUppercaseCapsLockParams()
{
...
class Uppercase_CapsLock : public ::testing::TestWithParam<KeyParam>
{};

TEST_P(Uppercase_CapsLock, keyGeneration)
{
