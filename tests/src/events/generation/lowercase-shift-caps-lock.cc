...
std::vector<KeyParam> generateLowercaseShiftCapsLockParams()
{
...
class Lowercase_ShiftCapsLock : public ::testing::TestWithParam<KeyParam>
{};

TEST_P(Lowercase_ShiftCapsLock, keyGeneration)
{
