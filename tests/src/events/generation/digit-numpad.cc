...
std::vector<KeyParam> generateDigitNumpadParams()
{
...
class Digit_Numpad : public ::testing::TestWithParam<KeyParam>
{};

TEST_P(Digit_Numpad, keyGeneration)
{
...
INSTANTIATE_TEST_SUITE_P(Events_KeyGenerator_Generate, Digit_Numpad,
                         ::testing::ValuesIn(generateDigitNumpadParams()));
