...
namespace brasio::renderer::vulkan {
    ...
    DepthAttachment::DepthAttachment(const PhysicalDeviceType &physicalDevice, const LogicalDeviceType &logicalDevice, const VkImageCreateInfo &imageInfo, const VkImageViewCreateInfo &imageViewInfo)
    ...
    {
        VkAttachmentReference attachmentReference = ImageAttachment::getAttachmentReference(attachmentId);
