...
namespace brasio::renderer::vulkan::builders
{
    ...
    PipelineShaderBuilder &PipelineShaderBuilder::withShader(const fs::path &shaderPath)
    {
        static std::map<std::string, VkShaderStageFlagBits> shaderStageByExtension = {
    ...
    PipelineShaderBuilder &PipelineShaderBuilder::withShaderPath(const fs::path &shaderPath)
    {
