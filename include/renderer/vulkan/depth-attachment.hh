...
namespace brasio::renderer::vulkan {
    ...
    class DepthAttachment : public ImageAttachment {
        ...
        public:
            DepthAttachment(const PhysicalDeviceType &physicalDevice, const LogicalDeviceType &logicalDevice, const VkImageCreateInfo &imageInfo, const VkImageViewCreateInfo &imageViewInfo);
