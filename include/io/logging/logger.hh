...
public:
     ...
     *
     * Writes a message to the output stream if the static logger level is lower
     * or equal (as integers) to the message level.
     *
     * @param   ostr            the output stream on which to write the message
     * @param   message         the message to write
     ...
     *
     * Writes a message to the output stream if the static logger level is lower
     * or equal (as integers) to LogLevel::TRACE.
     *
     * @param   ostr            the output stream on which to write the message
     * @param   message         the message to write
     * @param   additionalTags  a list of additional tags, defaults to empty
     ...
     *
     * Writes a message to the output stream if the static logger level is lower
     * or equal (as integers) to LogLevel::DEBUG.
     *
     * @param   ostr            the output stream on which to write the message
     * @param   message         the message to write
     * @param   additionalTags  a list of additional tags, defaults to empty
     ...
     *
     * writes a message to the output stream if the static logger level is lower
     * or equal (as integers) to LogLevel::INFO.
     *
     * @param   ostr            the output stream on which to write the message
     * @param   message         the message to write
     * @param   additionalTags  a list of additional tags, defaults to empty
     ...
     *
     * writes a message to the output stream if the static logger level is lower
     * or equal (as integers) to LogLevel::WARNING.
     *
     * @param   ostr            the output stream on which to write the message
     * @param   message         the message to write
     * @param   additionalTags  a list of additional tags, defaults to empty
     ...
     *
     * writes a message to the output stream if the static logger level is lower
     * or equal (as integers) to LogLevel::ERROR.
     *
     * @param   ostr            the output stream on which to write the message
     * @param   message         the message to write
     * @param   additionalTags  a list of additional tags, defaults to empty
     ...
     *
     * writes a message to the output stream if the static logger level is lower
     * or equal (as integers) to LogLevel::CRITICAL, which should always be the
     * case.
     *
     * @param   ostr            the output stream on which to write the message
     * @param   message         the message to write
